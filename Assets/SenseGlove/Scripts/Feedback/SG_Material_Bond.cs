...
namespace SG
{
    ...
    public class SG_Material_Bond : MonoBehaviour
    {
        //----------------------------------------------------------------------------------
        // Properties
        ...
        public int CalculateForce(float displacement, int fingerIndex)
        {
            ...
            {
                return (int)SG_Material_Bond.CalculateResponseForce(displacement, (int)(this.materialProperties.maxForce * 100), this.materialProperties.maxForceDist, ref this.materialProperties.forceRepsonse);
            }
